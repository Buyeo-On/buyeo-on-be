...
@RestControllerAdvice(assignableTypes = CitizenCardController.class)
public class CitizenCardExceptionHandler {

	@ExceptionHandler({InvalidCitizenCardRequestException.class, HttpMessageNotReadableException.class})
