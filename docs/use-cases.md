...
유즈케이스는 주도하는 도메인 아래에 개별 파일로 관리한다. 각 파일의 frontmatter가 참여 도메인, 적용 정책, API와 ADR을 지정한다.

## 회원

- [UC-01 로그인](./domains/member/use-cases/uc-01-login.md)
- [UC-02 가입](./domains/member/use-cases/uc-02-sign-up.md)
...
- [UC-22 로그아웃](./domains/member/use-cases/uc-22-logout.md)

## 여행

- [UC-05 여행 시작](./domains/trip/use-cases/uc-05-start-trip.md)
...
- [UC-07 가볼 곳 탐색](./domains/place/use-cases/uc-07-explore-places.md)
- [UC-08 가볼 곳 저장](./domains/place/use-cases/uc-08-save-place.md)
- [UC-12 저장한 장소 조회](./domains/place/use-cases/uc-12-view-saved-places.md)
- [UC-13 저장한 장소 삭제](./domains/place/use-cases/uc-13-delete-saved-place.md)
...
- [UC-14 배지 획득](./domains/badge/use-cases/uc-14-award-badge.md)
- [UC-18 배지 진척도 조회](./domains/badge/use-cases/uc-18-view-badge-progress.md)
