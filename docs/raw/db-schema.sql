...
CREATE TYPE term_type AS ENUM ('SERVICE', 'PRIVACY', 'LOCATION', 'MARKETING', 'PHOTO');
...
CREATE TYPE notification_type AS ENUM ('POINT', 'BADGE', 'NEARBY_QUIZ', 'DISCOUNT', 'CITIZEN_CARD', 'BUYEO_NEWS', 'BUYEO_ENTRY', 'BUYEO_EXIT');
